...
select 
	...
	case 
		...
		when (details like 'Git clone failed: Could not switch%' or details like 'Git clone failed: %Permission denied%' or details like 'Git clone failed: could not create work%' or  details like 'Git clone failed: destination path%' or details like 'Git clone failed: cannot copy%File exists%' or details like 'Git clone failed: Invalid path%' or details like 'Git clone failed: Not a git repo%' or details like 'Git clone failed: Cloning into%') then 'Bad path'
		when (details like 'Git clone failed: repository%not found%' or details like 'Git clone failed: unable to access%' or details like 'Git clone failed: Could not read from%' or details like 'Git clone failed: Project not found%' or details like 'Git clone failed: unable to checkout%' or details like 'Git clone failed: Remote branch%not found%') then 'Bad Git repo'
